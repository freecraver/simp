...
from zimp.pos.countvectorizer_analyzer import SymbolCountVectorizer
...
class SymbolCountVectorizerAnalyzerTest(unittest.TestCase):
    ...
    def test_count_symbols(self):
        scva = SymbolCountVectorizer(texts)
        self.assertEqual(
    ...
    def test_count_symbols_preserve_whitespace(self):
        scva = SymbolCountVectorizer(texts, remove_whitespace=False)
        self.assertEqual(
    ...
    def test_count_symbols_alpha(self):
        scva = SymbolCountVectorizer(texts, only_alphabetic=True)
        self.assertEqual(
    ...
    def test_count_symbols_alpha_lowercase(self):
        scva = SymbolCountVectorizer(texts, only_alphabetic=True, lowercase=True)
        self.assertEqual(
